...
def compute_signals(df, rsi_len=14):
    # Leeres DataFrame oder fehlende Close-Spalte -> sofort zurück
    ...
    # Prüfen, ob mindestens ein gültiger Wert vorhanden ist
    ...
    # DropNA nur, wenn gültige Werte vorhanden sind
